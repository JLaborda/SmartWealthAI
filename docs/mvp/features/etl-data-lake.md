...
- Curated fundamentals writes preserve all versions for the documented
  `(cik, fiscal_period_end, as_of_date, version_id)` natural key within each
  `cik=<cik>/period=<YYYYQn>` partition.
