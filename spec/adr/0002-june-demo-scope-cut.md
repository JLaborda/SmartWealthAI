...
**Consequences:** Documented in [`spec/constitution/roadmap.md`](../constitution/roadmap.md). Full feature specs remain the north star; modules marked deferred are unchanged in intent. MLflow logs **pipeline runs** in the demo; the `backtesting` experiment starts in phase 2.
